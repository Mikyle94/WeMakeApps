...
export default function DashboardPage() {
  ...
  const loadApps = useCallback(async () => {
    ...
    try {
       ...
       * ---------------------------------------------------------
       *
       * Supabase reads the existing browser session here.
       *
       * If you have already signed in previously, you do NOT
       * need to log in every time you visit /dashboard.
       */
      ...
      /*
       * Show the email of the currently authenticated user.
       */
       ...
       * IMPORTANT:
       *
       * We are NOT passing user.id into this query.
       *
       * Supabase RLS should determine which apps this user
       * is allowed to see.
       *
      ...
      /*
       * Supabase may return the relationship as an object or
       * array depending on the generated relationship metadata.
       *
       * We normalise it before displaying.
       */
  ...
  function continueBuilding(appId: string) {
    router.push(
      `/builder?appId=${encodeURIComponent(appId)}`,
    );
  }
  ...
  function createNewApp() {
    /*
     * Explicitly mark this as a NEW app.
     * The builder must never reuse the last saved app ID when creating
     * a new project.
     */
  ...
  async function signOut() {
    ...
    try {
      ...
      /*
       * Once signed out, send the user back to the builder.
       *
       * The builder will then ask them to create/sign into
       * an account when they try to save.
       */
                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-5 flex items-center justify-between border-t border-zinc-100 pt-4">
                      ...
                      <button
                        ...
                        className="text-sm font-semibold text-zinc-950 transition hover:translate-x-0.5"
                      >
                        Continue building →
                      </button>
                    </div>
